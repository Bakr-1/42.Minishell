...
#    Updated: 2023/01/18 15:19:24 by aalseri          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
test3:
	...
	@$(ECHO)	'||====================================================================||'
	@$(ECHO)	'||//$$\\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//$$\\||'
	@$(ECHO)	'||(100)==================| FEDERAL RESERVE NOTE |================(100)||'
	@$(ECHO)	'||\\$$//        ~         '------========--------'                  \\$$//||'
	@$(ECHO)	'||<< /        /$$\              // ____ \\                         \ >>||'
	@$(ECHO)	'||>>|  12    //L\\            // ///..) \\         L38036133B   12 |<<||'
	@$(ECHO)	'||<<|        \\ //           || <||  >\  ||                        |>>||'
	@$(ECHO)	'||>>|         \$$/             ||  $$ 3 /  ||        One Hundred     |<<||'
	@$(ECHO)	'||<<|      L38036133B        *\\  |\_/  //* series                 |>>||'
	@$(ECHO)	'||>>|  12                     *\\/___\_//*   1999                  |<<||'
	@$(ECHO)	'||<<\      ABUBAKER     ______/Franklin\________       MEERA    12 />>||'
	@$(ECHO)	'||//$$\                       ~|MONEYSHELL|~                       /$$\\||'
	@$(ECHO)	'||(100)===================  ONE HUNDRED DOLLARS =================(100)||'
	@$(ECHO)	'||\\$$//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\\$$//||'
	@$(ECHO)	'||====================================================================||'
